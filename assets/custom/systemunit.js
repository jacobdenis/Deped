$(document).ready(function(){
  ...
  $( "#SystemUnit" ).submit(function( event ) {
    event.preventDefault();
    data=getformvaluesassociative("#SystemUnit");
    data['AssetID']=AssetID;
    Method='';
    if(AssetID==''){
      Method='AddAsset';
  ...
  $('#systemunits_datatable').DataTable({
		"order": [[ 1, "desc" ]],
		"autoWidth": false,
        ...
        <button type="button" value="${data.AssetID}" class="btn btn-primary btn-sm show-edit-systemunit"><i class="fas fa-pencil-alt"></i></button> 
        <button type="button" value="${data.AssetID}" class="btn btn-danger btn-sm delete-systemunit"><i class="fas fa-times"></i></button>`;
      }},
			{"data":'AssetTag','title':'Asset Tag'},
			{"data":'HostName','title':'Hostname'},
			{"data":'SystemModel','title':'System Model'},
			{"data":'SerialNumber','title':'Serial Number'},
			{"data":'Casing','title':'Case'},
			{"data":'MotherBoard','title':'Mobo'},
